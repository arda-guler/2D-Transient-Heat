...
class Jet_A1(material):
    ...
    def get_specific_heat(self, temp):
        # takes temperature in K
        # returns specific heat in J kg-1 K-1
        # inter/extra-polated from Figure 70 of AFRL-RQ-WP-TR-2020-0017
        return (0.0036 * temp + 0.8225) * 1000

    def get_specific_gravity(self):
        # Jet A-1 density divided by water density
        return self.get_density()/997.77
    ...
    def get_viscosity(self, temp):
        ...
        # visc_cst = -0.038333 * temp + 13.198249
        visc_cst = -8.458 * math.log(temp) + 50.145

        # centipoise = centistokes * specific_gravity
        # now do the conversion
        visc_cP = visc_cst * self.get_specific_gravity()
